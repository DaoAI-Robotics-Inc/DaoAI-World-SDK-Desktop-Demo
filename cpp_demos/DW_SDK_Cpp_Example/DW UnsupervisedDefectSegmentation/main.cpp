...
int main()
{
    ...
    try
    {
         ...
         */
        std::cout << "step 2: Call the DaoAI API to load the unsupervised defectSegmentation model" << std::endl;
        ...
        DaoAI::DeepLearning::Vision::UnsupervisedDefectSegmentationResult prediction = model.inference(image);
