...
int main()
{
    ...
    std::string image_path = rootpath + "od.png";   // Image file path
    std::string model_path = rootpath + "od_acc.dwm"; // Model file path
    ...
    try
    {
        ...
        DaoAI::DeepLearning::Image image2(image_path);
