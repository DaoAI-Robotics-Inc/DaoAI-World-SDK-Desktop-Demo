...
def generate_output_paths(base_dir=r"python_demos\output"):
    ...
    image_output_path = os.path.join(image_output_dir, f"object_detection_result_{timestamp}.png")
    json_output_path = os.path.join(json_output_dir, f"object_detection_prediction_{timestamp}.json")
    annotation_output_path = os.path.join(json_output_dir, f"object_detection_annotation_{timestamp}.json")
...
def main():
    ...
    logger.info("=== Object Detection Demo Completed ===")
