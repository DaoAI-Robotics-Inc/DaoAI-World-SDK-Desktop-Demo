...
namespace instance_segmentation
{
    class Program
    {
        ...
        static void TestImageProcessingAndOCR(string image_path, string model_path1, string result_path)
        {
            ...
            DaoAI.DeepLearningCLI.Vision.InstanceSegmentation model = new DaoAI.DeepLearningCLI.Vision.InstanceSegmentation(model_path, DaoAI.DeepLearningCLI.DeviceType.GPU, -1);
            ...
            DaoAI.DeepLearningCLI.Vision.InstanceSegmentationResult result_pred = model.inference(daoai_image,post_params);
