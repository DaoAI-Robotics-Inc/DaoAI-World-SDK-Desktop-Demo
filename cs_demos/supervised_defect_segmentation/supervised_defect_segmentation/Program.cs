...
namespace supervised_defect_segmentation
{
    class Program
    {
        ...
        static void TestImageProcessingAndOCR(string image_path, string model_path1, string result_path)
        {
            ...
            DaoAI.DeepLearningCLI.Vision.SupervisedDefectSegmentation model = new DaoAI.DeepLearningCLI.Vision.SupervisedDefectSegmentation(model_path, DaoAI.DeepLearningCLI.DeviceType.GPU, -1);
