...
namespace unsupervised_defect_segmentation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string fileName = "../../../../../../../Data/unsupervised_defect_segmentation_img.png";
            string filemodel = "../../../../../../../Data/unsupervised_defect_segmentation_model.dwm";
        ...
        static void TestImageProcessingAndOCR(string image_path, string model_path1, string result_path)
        {
            ...
            DaoAI.DeepLearningCLI.Vision.UnsupervisedDefectSegmentation model = new DaoAI.DeepLearningCLI.Vision.UnsupervisedDefectSegmentation(model_path, DaoAI.DeepLearningCLI.DeviceType.GPU, -1);
            ...
            DaoAI.DeepLearningCLI.Vision.UnsupervisedDefectSegmentationResult result_pred = model.inference(daoai_image);
